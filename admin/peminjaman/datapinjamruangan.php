			...
			<div class="modal-content">
				...
				<form method="POST" enctype="multipart/form-data" action="">
					<div class="modal-body">
						...
						<input type="hidden" name="tgl_mulai" value="<?php echo $row['tanggal_mulai'] ?>">
						<input type="hidden" name="tgl_selesai" value="<?php echo $row['tanggal_selesai'] ?>">
...
if (isset($_POST['ubah'])) {
	...
	$password = $_POST['password_pengirim'];
