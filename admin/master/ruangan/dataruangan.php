<div class="main-panel">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="#modalDetailRuangan<?php echo $ruangan['id_ruangan'] ?>"  data-toggle="modal" title="Detail" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
														<a href="#modalEditRuangan<?php echo $ruangan['id_ruangan'] ?>"  data-toggle="modal" title="Edit" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
														<a href="#modalHapusRuangan<?php echo $ruangan['id_ruangan'] ?>"  data-toggle="modal" title="Hapus" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
											<?php } ?>
											</tbody>
		...
		<div class="modal fade" id="modalAddRuangan" tabindex="-1" role="dialog" aria-hidden="true">
									...
									<div class="modal fade" id="modalEditRuangan<?php echo $d['id_ruangan'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header no-bd">
													<h5 class="modal-title">
												...
												<form method="POST" enctype="multipart/form-data" action="">
												<div class="modal-body">
													<input type="hidden" name="id" value="<?php echo $d['id_ruangan'] ?>">
													<div class="form-group">
														<label>Nama Ruangan</label>
									...
									<div class="modal fade" id="modalHapusRuangan<?php echo $row['id_ruangan'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header no-bd">
													<h5 class="modal-title">
												...
												<form method="POST" enctype="multipart/form-data" action="">
												<div class="modal-body">
													<input type="hidden" name="id" value="<?php echo $row['id_ruangan'] ?>">
									...
									<div class="modal fade" id="modalDetailRuangan<?php echo $k['id_ruangan'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header no-bd">
													<h5 class="modal-title">
												...
												<form method="POST" enctype="multipart/form-data" action="">
												<div class="modal-body">
													<input type="hidden" name="id" value="<?php echo $k['id_ruangan'] ?>">
													<div class="form-group">
														<label>Nama Ruangan</label>
            ...
            if(isset($_POST['simpan']))
                {
                    ...
                    mysqli_query($conn,"INSERT INTO ruangan VALUES ('','$nama_ruangan','$deskripsi','free')");
                ...
                elseif(isset($_POST['ubah']))
                {
                    ...
                    mysqli_query($conn,"UPDATE ruangan SET id_ruangan='$id_ruangan', nama_ruangan='$nama_ruangan', deskripsi='$deskripsi', status='free' WHERE ruangan.id_ruangan='$id_ruangan'");
                ...
                elseif(isset($_POST['hapus']))
                {
                	...
                	mysqli_query($conn,"DELETE FROM ruangan WHERE ruangan.id_ruangan='$id_ruangan'");
