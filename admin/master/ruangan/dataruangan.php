									...
									<div class="modal fade" id="modalDetailRuangan<?php echo $k['id_ruangan'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form method="POST" enctype="multipart/form-data" action="">
												<div class="modal-body">
													<input type="hidden" name="id_ruangan" value="<?php echo $k['id_ruangan'] ?>">
													<div class="form-group">
														<label>Nama Ruangan</label>
		...
		<?php
            if(isset($_POST['simpan']))
                ...
                elseif(isset($_POST['ubah']))
                {
                    ...
                    mysqli_query($conn,"UPDATE ruangan SET id_ruangan='$id_ruangan', nama_ruangan='$nama_ruangan', deskripsi='$deskripsi', status='free' WHERE id_ruangan='$id_ruangan'");
