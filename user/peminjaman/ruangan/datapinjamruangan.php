									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												?>
												<?php if($_SESSION['id_pemakaian'] == $pemakaian['user_id']) { ?>
												<tr>
													<td><?php echo $no++ ?></td>
													...
													<td>
														...
														<a href="#modalHapusPinjamRuangan<?php echo $pemakaian['id_pemakaian'] ?>" data-toggle="modal" title="Batal Pinjam" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> Batal</a>
													<?php }elseif($pemakaian['status'] == 'approve') { ?>
														<a href="?view=detailpinjamruangan&id=<?php echo $pemakaian['id_pemakaian'] ?>" title="Detail" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
														<a href="#modalKembalikanPinjamRuangan<?php echo $pemakaian['id_pemakaian'] ?>" data-toggle="modal" title="Batal Pinjam" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> Kembalikan</a>
													<?php }else { ?>
														<a href="?view=detailpinjamruangan&id=<?php echo $pemakaian['id_pemakaian'] ?>" title="Detail" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
														<div class="badge badge-success"><?php echo $pemakaian['status'] ?></div>
													<?php } ?>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<input type="hidden" name="id" value="<?php echo $row['id_pemakaian'] ?>">
