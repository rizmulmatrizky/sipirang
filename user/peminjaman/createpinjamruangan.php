							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<select class="form-control" id="id_kegiatan" name="id_kegiatan" required="">
										...
										$jenis_kegiatan = "var jenis_kegiatan= new Array();\n;";
										while ($row = mysqli_fetch_array($query)) {
											echo '<option value="' . $row['id_kegiatan'] . '">' . $row['jenis_kegiatan'] . '</option>';
											$jenis_kegiatan .= "jenis_kegiatan['" . $row['id_kegiatan'] . "'] = {jenis_kegiatan:'" . addslashes($row['jenis_kegiatan']) . "'};\n";
										}
										?>
									</select>
								</div>
...
if (isset($_POST['simpan'])) {
	...
	mysqli_query($conn, "INSERT into pemakaian values ('', '$tanggal_mulai', '$tanggal_selesai', '$status', '$user_id', '$id_ruangan', '$id_kegiatan')");
